...
export default function LoginPage() {
	return (
		<div className="theme-surface-strong rounded-3xl border border-zinc-200/80 bg-white/90 p-6 shadow-[0_24px_80px_-48px_rgba(24,24,27,0.45)] backdrop-blur dark:border-zinc-800 dark:bg-zinc-900/85 sm:p-7">
			<div className="mb-5">
